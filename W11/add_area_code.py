...
def add_area_code(phone_number):
    ...
    """
    # b. At line 32, check if the length of a phone number is less than 12
    if len(phone_number) < 12:
        # Add the area code "208-" at the beginning of the phone number
        return "208-" + phone_number
    else:
        # Return the phone number as is if it already has an area code
        return phone_number
