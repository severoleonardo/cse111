...
CreatorUser: Leonardo Severo Elias

Purpose: Write and test a molar mass calculator named chemistry.py. 
'''


def make_periodic_table():
    # Creates a compound list with element data
    periodic_table_list = [
...
def main():
    # Call the make_periodic_table function and store the returned list
